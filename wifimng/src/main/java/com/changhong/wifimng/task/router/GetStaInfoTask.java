 ...
 * 6.2.4	获取STA信息
 */
public class GetStaInfoTask extends BaseRouterTask {
    public final GetStaInfoTask execute(String gateway, String cookies, TaskListener<List<StaInfo>> listener) {
    ...
    protected TaskResult _doInBackground(TaskParams... params) {
        ...
        try {
            ...
            if (responseAllBeen.getErr_code() != 0) {
                ...
                publishProgress(responseAllBeen.getSta_info());
