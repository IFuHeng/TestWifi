...
public class GetWizardWlanTask extends BaseRouterTask {
    public final GetWizardWlanTask execute(String gateway, String deviceType, String cookies, TaskListener<ResponseAllBeen> listener) {
    ...
    protected TaskResult _doInBackground(TaskParams... params) {
        ...
        try {
            ...
            if (DeviceType.PLC.getName().equals(deviceType)) {// 电力猫的情况
                ...
                String body = "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"wizard_wan_show\",\"param\":{\"src_type\":1}}";
            ...
            // mesh or router
                ...
                response = DefaultHttpUtils.httpPostWithJson(url,
                        new RequestBeen(HttpRequestMethod.METHOD_WIZARD_GET_NETWORK, requireBody).toJsonString(),
                        cookies
                );
