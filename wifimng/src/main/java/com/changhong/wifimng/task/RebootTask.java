 ...
 * 重启
 */
public class RebootTask extends BaseRouterTask {

    public final RebootTask execute(String gateway, String deviceType, String cookies, TaskListener<String> listener) {
        ...
        try {
            ...
            // mesh or router
                ...
                response = DefaultHttpUtils.httpPostWithJson(url,
                        "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"" + HttpRequestMethod.METHOD_REBOOT + "\",\"params\":{\"src_type\":1}}",
                        cookies
                );
