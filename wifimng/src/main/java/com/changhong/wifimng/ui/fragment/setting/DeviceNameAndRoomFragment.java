 ...
 * @since 20200221
 */
public class DeviceNameAndRoomFragment extends BaseFragment<BaseBeen<EnumPage, Object>> implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        //更新名字
            ...
            if (deviceItem == mMainDeviceInfo) {//主节点更新名称
                ...
                showInputDialog(false, false, deviceItem, false);//mDeviceType == DeviceType.PLC);
            }
        }
